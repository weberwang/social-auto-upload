...
This project is indexed by GitNexus as **social-auto-upload** (4118 symbols, 8396 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/social-auto-upload/context` | Codebase overview, check index freshness |
| `gitnexus://repo/social-auto-upload/clusters` | All functional areas |
| `gitnexus://repo/social-auto-upload/processes` | All execution flows |
| `gitnexus://repo/social-auto-upload/process/{name}` | Step-by-step execution trace |
